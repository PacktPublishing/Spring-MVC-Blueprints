...
public class PersonalUpdateController {
	...
	public void initBinder(WebDataBinder binder){
	    ...
	    binder.registerCustomEditor(Integer.class, "biography.age", new AgeConverter());	
	    binder.registerCustomEditor(Integer.class, "education.year", new YearConverter());	
	    binder.registerCustomEditor(Date.class, "biography.birthDate", new BirthDateConverter());	
	}

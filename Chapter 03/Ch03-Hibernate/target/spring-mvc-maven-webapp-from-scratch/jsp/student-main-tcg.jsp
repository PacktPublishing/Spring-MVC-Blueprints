...
<div class="wrapper row2">
  <div class="rounded">
    <nav id="mainav" class="clear"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li><a href="./student-main-tcg.html">Home</a></li>
      ...
      <div id="content" class="three_quarter"> 
        ...
        <div class="scrollable">
          ...
          <table>
            ...
            <tbody>
            <c:forEach var="grade" items="${ courseTaken }">
              <tr>
                <td><c:out value="${ grade.getTblcourses().getCourseCode() }"/></td>
                <td><c:out value="${ grade.getTblcourses().getCourseName() }"/></td>
                <td><c:out value="${ grade.getTblcourses().getCourseUnit() }"/></td>
          ...
          <strong>GWA: <font color="RED"><c:out value="${ gwa }" /></font></strong> 
        </div>

...
<div class="wrapper row2">
  <div class="rounded">
    <nav id="mainav" class="clear"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li><a href="./admin-main-faculty-disable.html">Home</a></li>
  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div id="content" class="three_quarter"> 
        ...
        <form:form commandName="adminStudentForm" method="POST">
        
            <label >ID <span>*</span></label>
            <form:input path="id" size="22"/>
            ...
            <form:input path="gender" size="22"/>
            
            <label >Birthdate<span>*</span></label>
            <form:input path="birthDate" size="22"/>
            
            <label >Address<span>*</span></label>
            <form:input path="address" size="22"/>
            
            <label >Mobile<span>*</span></label>
            <form:input path="mobile" size="22"/>
            
            <label >Email<span>*</span></label>
            <form:input path="email" size="22"/>
          <div>

...
<div class="wrapper row0">
  <div id="topbar" class="clear"> 
    ...
    <nav>
     <ul>
        <li><a href='<c:url value="./admin_login.html"  />'>Logout</a></li>
      </ul>
    </nav>
    <!-- ################################################################################################ --> 
  </div>
  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div id="content" class="three_quarter"> 
        ...
        <form:form commandName="courseForm" method="POST">
        
            <label >Department ID <span>*</span></label>
            <form:select path="deptId" items="${ deptId }"/>
            
            <label >Course Code <span>*</span></label>
            <form:input path="courseCode" size="22"/>
            
            <label >Course Name <span>*</span></label>
            <form:input path="courseName" size="22"/>
            
            <label >Course Unit <span>*</span></label>
            <form:select path="courseUnit" items="${ units }"/>
        ...
        <h1>Courses Available</h1>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td><c:out value="${ course.tbldepartment.departmentId }"/></td>
                <td><c:out value="${ course.courseCode }"/></td>
                <td><c:out value="${ course.courseName }"/></td>
                <td><c:out value="${ course.courseUnit }"/></td>
                <td></td>
              </tr>
              </c:forEach>
            </tbody>

...
<html>
<head>
<title>EDMS-Administration Login</title>
<meta charset="utf-8">
      ...
      <ul class="clear">
        ...
        <li><a class="drop" href="#">Services</a>
          <ul>
            ...
            <li><a href="./stud_login.html">Student Login</a></li>
            <li><a href="./faculty_login.html">Staff Login</a></li>
            <li><a href="./basic_grid.html">Basic Grid</a></li>
          </ul>
        </li>
        <li><a href="./stud_application.html">Student Application</a></li>
...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
      <!-- main body --> 
      <!-- ################################################################################################ -->
      <c:set var="elapsed" value="${ accessTime }" />
      <c:if test="${ elapsed ne '' }">
          <h2><font color="Red">Your are logged out. Time used is :<c:out value="${ elapsed }" /></font></h2>
      </c:if>
      <h1>Administrator's Login</h1>
     
 
        <form:form commandName="adminLoginForm" method="POST">

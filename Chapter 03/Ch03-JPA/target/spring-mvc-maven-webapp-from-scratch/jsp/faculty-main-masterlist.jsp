...
<div class="wrapper row2">
  <div class="rounded">
    <nav id="mainav" class="clear"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li><a href="./faculty-main-masterlist.html">Home</a></li>
      </ul>
      <!-- ################################################################################################ --> 
    </nav>
  </div>
      ...
      <div id="content" class="three_quarter"> 
        ...
        <div class="scrollable">
         <table>
            ...
            <tbody>
            <c:forEach var="grade" items="${ listForm.listJoinedStudentList }">
              <tr>
                <td><c:out value="${ grade.studentId }"/></td>
                <td><c:out value="${ grade.lastName }, ${ grade.firstName }"/></td>
                <td><c:out value="${ grade.gender }"/></td>
                <td><c:out value="${ grade.level }"/></td>
                <td><c:out value="${ grade.semester }"/></td>
                <td><c:out value="${ grade.courseCode }"/></td>

...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="hr_index.html"><i class="icon-dashboard"></i><span>Dashboard</span> </a> </li>
        <c:url var="hr_reports_url" value="/hrms/hr_reports" />
        <li><a href='<c:out value="${ hr_reports_url}"/>'><i class="icon-list-alt"></i><span>Reports</span> </a> </li>
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-long-arrow-down"></i><span>Management</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="hr_add_department.html">Add Department</a></li>
            <li><a href="hr_add_employee.html">Add Employee</a></li>
            <li><a href="hr_add_leaves.html">Add Leaves</a></li>
            <li><a href="faq.html">FAQ</a></li>
      
          </ul>
        </li>
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-long-arrow-down"></i><span>Master Table</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="hr_leaves_employees.html">Manage Leaves</a></li>
            <li><a href="hr_project_employees.html">Project Performance</a></li>
            <li><a href="hr_trainings_employees.html">Trainings and Bonds</a></li>
            <li><a href="hr_view_employees.html">List Employees</a></li>
            <li><a href="faq.html">FAQ</a></li>
          </ul>
        </li>
      </ul>

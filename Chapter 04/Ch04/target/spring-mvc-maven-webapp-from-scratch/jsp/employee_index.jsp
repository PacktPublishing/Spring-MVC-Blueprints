...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="employee_index.html"><i class="icon-dashboard"></i><span>Dashboard</span> </a> </li>
         <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-long-arrow-down"></i><span>Transactions</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="./atom_feeds"><i class="icon-list-alt"></i><span>Atom Feeds</span> </a> </li>
        <li><a href="./rss_feeds"><i class="icon-list-alt"></i><span>RSS Feeds</span> </a> </li>
         <li><a href="./dtr.html"><i class="icon-list-alt"></i><span>DTR</span> </a> </li>
        <li><a href="./employee_edit_profile.html"><i class="icon-list-alt"></i><span>Edit</span> </a> </li>

									...
									<fieldset>
										...
										<div class="control-group">											
											...
											<div class="controls">
												...
												<p class="help-block">The Employee ID must be final and cannot be changed.</p>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span4" id="birthdate" value="October 30, 1978">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
                                        ...
                                        <div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span4" id="age" value="37">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span4" id="sex" value="Male">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span4" id="address" value="Male">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
                                       ...
                                       <div class="control-group">											
										...
										<div class="control-group">											
											<label class="control-label" for="radiobtns">Department</label>
										...
										<div class="control-group">											
											<label class="control-label" for="employedDate">Employed Date</label>
											<div class="controls">
												<input type="text" class="span4" id="employedDate" value="Male">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->

        ...
        <nav>
          <ul id="menu">
           <c:url value="/hms/index?theme=main" var="index"/>
            ...
            <li class="active"><a href='<c:out value="${ booking }"/>'>Booking</a></li>
            ...
            <div class="wrapper">
              ...
              <div class="col2 pad">
                ...
                <div class="wrapper line1">
                  <div class="col3">
                    <a href="./ng/getRoomTypesPage" class="button2">Add Room Type</a> 
                    <p class="pad_bot1"><strong class="color3">An angularJS implementation</strong></p>
                    <p>Adipisicing elito eiusmod tempor incididunt ut labore dolore magna.</p>
                    </div>
                  <div class="col3 pad_left2">
                    <a href="./ng/addUserBooking" class="button2">Add Booking</a> 
                    <p class="pad_bot1"><strong class="color3">An angularJS implementation</strong></p>

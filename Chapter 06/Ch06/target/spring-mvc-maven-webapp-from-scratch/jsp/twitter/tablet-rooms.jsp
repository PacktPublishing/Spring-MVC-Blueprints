...
<body>
  <h1 class="visible-xs">For Android Users Only</h1>
  <h1 class="visible-md">For Mobile Users Only</h1>
  <h1 class="visible-lg">For Desktop Users only</h1>
	<div class="container">
			...
			<div class="col-sm-4">
				<div class="bs-example">
					...
					<a href="#myModal" class="btn btn-lg btn-primary"
						data-toggle="modal">Reserve Room</a>
		...
		<div class="row">
			<div class="col-sm-3" class="stub-space">
				<div class="stub-space.bg-alt" /></div>
				<div class="col-sm-9" class="stub-space">
					<div class="stub-space.bg-alt" /></div>
				</div>
			</div>
		</div>

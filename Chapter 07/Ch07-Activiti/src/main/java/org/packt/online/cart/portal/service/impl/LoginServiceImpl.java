...
import org.packt.online.cart.portal.security.digester.CartPasswordEncoder;
...
public class LoginServiceImpl implements LoginService {
	...
	public void addAccount(LoginForm login) {
		CartPasswordEncoder encoder = new CartPasswordEncoder();
		...
		credential.setEncPassword(passwordEncoder.encodePassword(login.getPassword(), login.getUsername()));

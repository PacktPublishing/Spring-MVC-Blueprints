URL to start: /ch07/ocs/login.html
URL to signup: /ch07/ocs/signup.html
...
How to run the project:
   ...
   (5) Must use Apache Pluto server for portlets to deploy else just configure pom.xml ot run in Jetty or JBoss.
   (6) For the BTM-JTA Manager configuration, all files are inside jata-server-conf folder

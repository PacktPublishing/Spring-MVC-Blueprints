...
<html >
  <head>
    ...
    <spring:url var="normalizeCSS" value="/erp-admin/css/normalize.css"/>
    <spring:url var="styleCSS" value="/erp-admin/css/style.css"/>
  ...
  <div class="logmod__wrapper">
    ...
    <spring:url var="indexJS" value="/erp-admin/js/index.js"/>

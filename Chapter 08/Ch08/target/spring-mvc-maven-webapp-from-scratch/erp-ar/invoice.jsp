...
<head>
	...
	<title>Packt Invoice Module</title>
	<spring:url var="styleCSS" value="/erp-ar/css/style.css"/>
    <spring:url var="stylePrintCSS" value="/erp-ar/css/print.css"/>
  	<spring:url var="jQuery" value="/erp-ar/js/jquery-1.3.2.min.js"/>
    <spring:url var="componentsJs" value="/erp-ar/js/example.js"/>
	<link rel='stylesheet' type='text/css' href='${ styleCSS }' />
	<link rel='stylesheet' type='text/css' href='${ stylePrintCSS }' media="print" />
		...
		<div id="identity">
            ...
            <div id="logo">
              ...
              <div id="logohelp">
               ...
               <spring:url var="imageLogo" value="/erp-ar/images/logo.png"/>

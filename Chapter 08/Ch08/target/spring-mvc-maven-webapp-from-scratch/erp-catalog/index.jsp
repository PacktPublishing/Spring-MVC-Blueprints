...
<body>
	...
	<form:form class="my-grid-form" commandName="invForm" >
		<fieldset>
			...
			<div data-row-span="2">
				<div data-field-span="1">
					<label>Vendor</label>
					<form:select path="vendor" items="${ suppliers }" />
				</div>
				<div data-field-span="1">
					<label>Product Type</label>
					<form:select path="typeId" items="${ materialTypes }"/>
				</div>
			</div>
			<div data-row-span="1">
				<div data-field-span="1">
			...
			<div data-row-span="5">
				<div data-field-span="1">
					<label>SKU</label>
					<form:select path="uomId" items="${ uomTypes }" />
				</div>
				<div data-field-span="1">
